      ...
      <nav class="bg-white dark:bg-gray-900 fixed w-full z-20 top-10 left-0 border-b border-gray-200 dark:border-gray-600">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4 flex-row">
          ...
          <div class="flex order-3">
            <button
              type="button"
              class="text-black border-[#0030FF] border-2 bg-white hover:bg-blue-800 hover:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
            >
              Get In Touch
            </button>
            <button
